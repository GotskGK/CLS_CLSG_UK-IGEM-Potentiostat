 ...
 */
 ...
 /* 
 * 2020-10-18
 Modifications by Gautam Krishna: Included code to run pump off L293d H Bridge and code to SWV data on SD card */
...
//  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  for (uint8_t i = 0; i < 5; i++)
  {
   ...
   for(uint16_t i = 0; i < arr_samples; i++)
   {
    ...
    SerialDebugger.println("Quiet time till next SWV run"); // 30 minute delay written at end of loop
  }
...
//  }
    ...
    delay(1800000); //30 minute delay before next run
...
void printInfo(float m, float b, float pk, int16_t vpk)
{
  ...
  SerialDebugger.println();
  File dataFile = SD.open("date: dd/mm/yy time: time: xx:zz .txt", FILE_WRITE);

  dataString += String(m,6);
  dataString += String(b,6);
  dataString += String(vpk);
  dataString += String(pk,2);
